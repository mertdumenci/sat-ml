...
def train_model(
    ...
    for t in range(epochs):
            ...
            with torch.no_grad():
                ...
                if step % print_every == 0:
                    ...
                    .format(
                        ...
                        step+1,
                        len(loader_train),
                        running_loss/steps_accrued,
                        running_accuracy/steps_accrued
                    ))
        ...
        # Checkpoint
        torch.save(model.state_dict(), os.path.join(args.checkpoint, "{}-{}epoch-{}valacc.pt".format(args.model, t, val_acc)))
